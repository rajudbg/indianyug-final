    ...
    <div className="w-full bg-[#f5f5f7] dark:bg-[#000000]">
      ...
      <section className="border-t border-b border-[#d2d2d7] dark:border-[#424245] bg-[#f5f5f7] dark:bg-[#000000]">
        <div className="max-w-[1024px] mx-auto py-8">
          <div className="flex gap-3 overflow-x-auto hide-scrollbar px-4 sm:px-6 lg:px-8 pb-4 -mb-4 snap-x">
            {topCats.map((c) => (
              <Link
                key={c.id}
                href={`/category/${c.slug}`}
                className="whitespace-nowrap snap-start px-5 py-2.5 rounded-full text-[14px] font-semibold tracking-wide
